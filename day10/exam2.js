...
let counter = 0;        // 0의 값을 가진 전역변수
function increaseCount(){
    counter++   // vs counter += 1
}
increaseCount(); // 함수 3번 호출
increaseCount();
increaseCount();
console.log(counter)    // counter값을 콘솔에 출력
...
function isPositive(x){     // 임의의 숫자 하나를 매개변수로 받아
    if(x>0){return true}    // 그 숫자가 0보다 크면 true
