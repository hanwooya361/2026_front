...
let fruitList = ['사과', '바나나'];
let user = prompt('과일 이름: ')
let newitem = fruitList.includes[user]
let olditem = fruitList[user]
if(olditem){console.log('존재하는 과일입니다')}
else{console.log('존재하지않는 과일입니다.')}
...
if(월== 3 & 4 & 5){console.log(`봄: ${월}`)}
else if(월== 6 & 7 & 8){console.log(`여름: ${월}`)}
else if(월== 9 & 10 & 11){console.log(`가을: ${월}`)}
else if(월== 12 & 1 & 2){console.log(`겨울: ${월}`)}
...
let 결과1 = 숫자1 > 숫자2 && 숫자1 > 숫자3
let 결과2 = 숫자2 > 숫자1 && 숫자2 > 숫자3
let 결과3 = 숫자3 > 숫자1 && 숫자3 > 숫자2
if(결과1){console.log(`가장 큰 수: ${숫자1}`)}
if(결과2){console.log(`가장 큰 수: ${숫자2}`)}
if(결과3){console.log(`가장 큰 수: ${숫자3}`)}
/*
문제 6: 윤년 판별기
