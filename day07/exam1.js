...
//  리타럴 ? 값 그 자체, 상수, 'a' 3 
// 자료 타입: 숫자, 문자열, 논리, 객체([ ], { }), 함수
//  * 주의할점 [ ], { } 안에 자료가 여러개 존재해도 자료 1개 취급

// [1] 객체 선언{ } vs 배열 선언 [ ]
{ }

// [2] 객체/배열는 주로 변수에 대입/저장 한다.
let 객체변수1 = { }
console.log(객체변수1)  // 객체가 저장된 변수 호출
// [3] 객체내 속성 (properties) 구성 , {'속성명' : 속성값 , 속성명 : 속성값}       속성명에 특수문자가 들어가게되면 꼭 '' 문자처리
const 객체변수2 = { 속성명1 : 10, '속성명2' : '안녕'}
console.log(객체변수2)
// [4] 객체내 속성 호출, .연산자 , 왼쪽자료의 속성들을 참조
...
delete 객체변수2.속성명3
// 객체변수2 = { }      // * 참고 : 객체지향 프로그밍에서 객체를 삭제하는 방법 : 해당 객체를 변수에 저장하지 않는다
console.log(객체변수2)
// [8] 객체내 여러 타입 저장
