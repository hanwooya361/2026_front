...
/* 
    웹스토리지
        ...
        [1] 로컬스토리지 : 로컬 저장소
            ...
            예] 자동로그인 / 로그인유지
        * 노출에 대한 위험한 경우 암호화를 통해 자료 변환 한다.
*/
// [1] 웹 스토리지 객체 호출
...
// --> 개발자도구 --> Application --> 세선스토리지 --> 도메인 클릭 
...
// [4] 웹 스토리지 객체 내 자료 삭제    .removeItem('key') , .clear('key')
sessionStorage.removeItem('name')   // 특정 key 존재하면 key/value 삭제
...
// JS는 브라우저가 F5 메모리가 초기화 된다. 
// 그래서 백엔드가 필요함 또는 브라우저 스토리지 사용